...
python doubao_dental_sam3_candidate_api.py \
  ...
  --score-scale 1.0 \
  --final-nms 0.45 \
  --out doubao_dental_sam3crop_2img_top35_rawapi_v1.json \
  --raw-dir doubao_dental_sam3crop_2img_top35_rawapi_v1_raw \
  --resume \
  --evaluate

python snap_fuse_qwen_sam3.py \
  --api doubao_dental_sam3crop_2img_top35_rawapi_v1.json \
  --image-ids 0,1 \
  --out doubao_dental_snapfuse_2img_v1.json
