...
Best local mAP: `0.374949`. Submitted category IDs are remapped from local Roboflow IDs by subtracting one because the local export contains a placeholder class at `category_id=0`.
